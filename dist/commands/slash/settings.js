...
export const data = new SlashCommandBuilder()
    ...
    .setRequired(true)
    .addChoices({ name: 'Road', value: 'ROAD' }, { name: 'Gravel', value: 'GRAVEL' }, { name: 'Mountain', value: 'MOUNTAIN' }, { name: 'Social', value: 'SOCIAL' }, { name: 'Virtual', value: 'VIRTUAL' }, { name: 'Race', value: 'RACE' }))
